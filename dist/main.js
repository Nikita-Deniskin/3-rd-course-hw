/******/ (() => {
  ...
  \******************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ renderCongratulation: () =>
            /* binding */ renderCongratulation,
          /* harmony export */ renderDifficultyComponent: () =>
            /* binding */ renderDifficultyComponent,
          /* harmony export */ renderGameComponent: () =>
            /* binding */ renderGameComponent,
          /* harmony export */
        });
        /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./utils */ "./components/utils.ts");
        /* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ../index */ "./index.ts");
      ...
      <button class="start-button">Старт</button>
        ...
        function renderGameComponent(appEl, level) {
          const cards = (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getCardsArray)(
            level,
          );
      ...
      <ul id="cards">${cardsHtml}</ul>
        ...
        `;
          ...
          if (timer) (0, _utils__WEBPACK_IMPORTED_MODULE_0__.initTimer)(timer);
          const restart = appEl.querySelector(".restart");
          if (restart)
            restart.onclick = () => {
              renderDifficultyComponent(appEl);
            };
          (0, _index__WEBPACK_IMPORTED_MODULE_1__.playGame)(cards);
        }
  ...
  \*****************************/
      /***/ (
        ...
        const getCardsArray = (difficult) => {
          ...
          const shuffledCards =
            lodash__WEBPACK_IMPORTED_MODULE_0__.shuffle(cards);
          const slicedArray = shuffledCards.slice(0, difficult / 2);
          const duplicatedArray = lodash__WEBPACK_IMPORTED_MODULE_0__.concat(
            slicedArray,
            slicedArray,
          );
  ...
  \******************/
      /***/ (
        ...
        /* harmony import */ var _components_render__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./components/render */ "./components/render.ts",
          );
        ...
        if (appEl)
          (0,
          _components_render__WEBPACK_IMPORTED_MODULE_0__.renderDifficultyComponent)(
            appEl,
          );
        function playGame(cards) {
          if (appEl) {
            ...
            cardsShirts.forEach((cardsShirt, index) => {
              setTimeout(() => {
                var _a;
                return (_a = cardsShirt.firstElementChild) === null ||
                  _a === void 0
                  ? void 0
                  ...
                  if (
                    ...
                    if (cards[firstCard] === cards[secondCard]) {
                      ...
                      if (appEl) {
                        ...
                        if (time)
                          (0,
                          _components_render__WEBPACK_IMPORTED_MODULE_0__.renderCongratulation)(
                            appEl,
                            time.innerText,
                          );
                      }
